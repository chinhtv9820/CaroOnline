        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    P1UserId = table.Column<int>(type: "INTEGER", nullable: true),
                    P2UserId = table.Column<int>(type: "INTEGER", nullable: true),
                    WinnerId = table.Column<int>(type: "INTEGER", nullable: true),
                    IsAi = table.Column<bool>(type: "INTEGER", nullable: false),
                    AiLevel = table.Column<int>(type: "INTEGER", nullable: true),
                    WinType = table.Column<string>(type: "TEXT", nullable: true),
                    PveDifficulty = table.Column<int>(type: "INTEGER", nullable: true),
                    TimeControlSeconds = table.Column<int>(type: "INTEGER", nullable: false),
                    CurrentTurn = table.Column<int>(type: "INTEGER", nullable: false),
                    RoomOwnerId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rankings_UserId_PeriodType_PeriodStart",
                table: "Rankings",
